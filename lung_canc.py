...
Original file is located at
    https://colab.research.google.com/drive/1HDKzGHA0_rNJIA40nOZW1AubXz--tXA2
"""
...
!unzip './drive/My Drive/test_and_train/lung_image_sets_01.zip'
...
# nb_train_samples = nb_train_samples * 4
# nb_validation_samples = nb_validation_samples * 4
...
print('The length of train_generator: ' + str(len(train_generator)),
      'THe length of validation_generator: ' + str(len(validation_generator)),
      # 'THe length of test_generator: ' + str(len(test_generator))
      )
#############################################
